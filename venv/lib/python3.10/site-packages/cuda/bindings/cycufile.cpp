...
*/
  ...
  __pyx_L1_error:;
  __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
  __Pyx_AddTraceback("cuda.bindings.cycufile.cuFileSetParameterString", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = CUFILE_LOADING_ERROR;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
/* "cuda/bindings/cycufile.pyx":137
 * 
 * 
...
static CUfileError_t __pyx_f_4cuda_8bindings_8cycufile_cuFileDriverClose(void) {
  CUfileError_t __pyx_r;
  CUfileError_t __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  /* "cuda/bindings/cycufile.pyx":138
 * 
 * cdef CUfileError_t cuFileDriverClose() except?<CUfileError_t>CUFILE_LOADING_ERROR nogil:
 *     return _cufile._cuFileDriverClose()             # <<<<<<<<<<<<<<
*/
  __pyx_t_1 = __pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverClose(); if (unlikely(__pyx_t_1 == CUFILE_LOADING_ERROR && __Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 138, __pyx_L1_error)
  __pyx_r = __pyx_t_1;
  goto __pyx_L0;
...
*/
  ...
  __pyx_L1_error:;
  __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
  __Pyx_AddTraceback("cuda.bindings.cycufile.cuFileDriverClose", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = CUFILE_LOADING_ERROR;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("cuFileHandleRegister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileHandleRegister, "CUfileError_t (CUfileHandle_t *, CUfileDescr_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileHandleDeregister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileHandleDeregister, "void (CUfileHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBufRegister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBufRegister, "CUfileError_t (void const *, size_t, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBufDeregister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBufDeregister, "CUfileError_t (void const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileRead", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileRead, "Py_ssize_t (CUfileHandle_t, void *, size_t, off_t, off_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileWrite", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileWrite, "Py_ssize_t (CUfileHandle_t, void const *, size_t, off_t, off_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverOpen", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverOpen, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverClose_v2", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverClose_v2, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileUseCount", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileUseCount, "long (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverGetProperties", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverGetProperties, "CUfileError_t (CUfileDrvProps_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverSetPollMode", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverSetPollMode, "CUfileError_t (bool, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverSetMaxDirectIOSize", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverSetMaxDirectIOSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverSetMaxCacheSize", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverSetMaxCacheSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverSetMaxPinnedMemSize", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverSetMaxPinnedMemSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBatchIOSetUp", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBatchIOSetUp, "CUfileError_t (CUfileBatchHandle_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBatchIOSubmit", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBatchIOSubmit, "CUfileError_t (CUfileBatchHandle_t, unsigned int, CUfileIOParams_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBatchIOGetStatus", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBatchIOGetStatus, "CUfileError_t (CUfileBatchHandle_t, unsigned int, unsigned int *, CUfileIOEvents_t *, struct timespec *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBatchIOCancel", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBatchIOCancel, "CUfileError_t (CUfileBatchHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileBatchIODestroy", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileBatchIODestroy, "void (CUfileBatchHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileReadAsync", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileReadAsync, "CUfileError_t (CUfileHandle_t, void *, size_t *, off_t *, off_t *, Py_ssize_t *, CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileWriteAsync", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileWriteAsync, "CUfileError_t (CUfileHandle_t, void *, size_t *, off_t *, off_t *, Py_ssize_t *, CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileStreamRegister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileStreamRegister, "CUfileError_t (CUstream, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileStreamDeregister", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileStreamDeregister, "CUfileError_t (CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileGetVersion", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileGetVersion, "CUfileError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileGetParameterSizeT", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileGetParameterSizeT, "CUfileError_t (CUFileSizeTConfigParameter_t, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileGetParameterBool", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileGetParameterBool, "CUfileError_t (CUFileBoolConfigParameter_t, bool *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileGetParameterString", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileGetParameterString, "CUfileError_t (CUFileStringConfigParameter_t, char *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileSetParameterSizeT", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileSetParameterSizeT, "CUfileError_t (CUFileSizeTConfigParameter_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileSetParameterBool", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileSetParameterBool, "CUfileError_t (CUFileBoolConfigParameter_t, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileSetParameterString", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileSetParameterString, "CUfileError_t (CUFileStringConfigParameter_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cuFileDriverClose", (void (*)(void))__pyx_f_4cuda_8bindings_8cycufile_cuFileDriverClose, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  __pyx_t_1 = PyImport_ImportModule("cuda.bindings._internal.cufile"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileHandleRegister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileHandleRegister, "CUfileError_t (CUfileHandle_t *, CUfileDescr_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileHandleDeregister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileHandleDeregister, "void (CUfileHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBufRegister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBufRegister, "CUfileError_t (void const *, size_t, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBufDeregister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBufDeregister, "CUfileError_t (void const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileRead", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileRead, "Py_ssize_t (CUfileHandle_t, void *, size_t, off_t, off_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileWrite", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileWrite, "Py_ssize_t (CUfileHandle_t, void const *, size_t, off_t, off_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverOpen", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverOpen, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverClose_v2", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverClose_v2, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileUseCount", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileUseCount, "long (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverGetProperties", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverGetProperties, "CUfileError_t (CUfileDrvProps_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverSetPollMode", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverSetPollMode, "CUfileError_t (bool, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverSetMaxDirectIOSize", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverSetMaxDirectIOSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverSetMaxCacheSize", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverSetMaxCacheSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverSetMaxPinnedMemSize", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverSetMaxPinnedMemSize, "CUfileError_t (size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBatchIOSetUp", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBatchIOSetUp, "CUfileError_t (CUfileBatchHandle_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBatchIOSubmit", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBatchIOSubmit, "CUfileError_t (CUfileBatchHandle_t, unsigned int, CUfileIOParams_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBatchIOGetStatus", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBatchIOGetStatus, "CUfileError_t (CUfileBatchHandle_t, unsigned int, unsigned int *, CUfileIOEvents_t *, struct timespec *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBatchIOCancel", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBatchIOCancel, "CUfileError_t (CUfileBatchHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileBatchIODestroy", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileBatchIODestroy, "void (CUfileBatchHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileReadAsync", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileReadAsync, "CUfileError_t (CUfileHandle_t, void *, size_t *, off_t *, off_t *, Py_ssize_t *, CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileWriteAsync", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileWriteAsync, "CUfileError_t (CUfileHandle_t, void *, size_t *, off_t *, off_t *, Py_ssize_t *, CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileStreamRegister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileStreamRegister, "CUfileError_t (CUstream, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileStreamDeregister", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileStreamDeregister, "CUfileError_t (CUstream)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileGetVersion", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileGetVersion, "CUfileError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileGetParameterSizeT", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileGetParameterSizeT, "CUfileError_t (CUFileSizeTConfigParameter_t, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileGetParameterBool", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileGetParameterBool, "CUfileError_t (CUFileBoolConfigParameter_t, bool *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileGetParameterString", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileGetParameterString, "CUfileError_t (CUFileStringConfigParameter_t, char *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileSetParameterSizeT", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileSetParameterSizeT, "CUfileError_t (CUFileSizeTConfigParameter_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileSetParameterBool", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileSetParameterBool, "CUfileError_t (CUFileBoolConfigParameter_t, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileSetParameterString", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileSetParameterString, "CUfileError_t (CUFileStringConfigParameter_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "_cuFileDriverClose", (void (**)(void))&__pyx_f_4cuda_8bindings_9_internal_6cufile__cuFileDriverClose, "CUfileError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __pyx_pymod_exec_cycufile(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cycufile},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_cycufile(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cycufile(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cycufile(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cycufile' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cycufile" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cycufile", 0);
  ...
  if (__pyx_module_is_main_cuda__bindings__cycufile) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cuda.bindings.cycufile")) {
      if (unlikely((PyDict_SetItemString(modules, "cuda.bindings.cycufile", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cuda.bindings.cycufile", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cuda.bindings.cycufile");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
