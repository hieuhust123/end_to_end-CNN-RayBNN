...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDeviceProperties_v2(struct cudaDeviceProp *__pyx_v_prop, int __pyx_v_device) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGetDeviceProperties_v2(__pyx_v_prop, __pyx_v_device);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetCaptureInfo_v2(cudaStream_t __pyx_v_stream, enum cudaStreamCaptureStatus *__pyx_v_captureStatus_out, unsigned PY_LONG_LONG *__pyx_v_id_out, cudaGraph_t *__pyx_v_graph_out, cudaGraphNode_t const **__pyx_v_dependencies_out, size_t *__pyx_v_numDependencies_out) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaStreamGetCaptureInfo_v2_ptsz(__pyx_v_stream, __pyx_v_captureStatus_out, __pyx_v_id_out, __pyx_v_graph_out, __pyx_v_dependencies_out, __pyx_v_numDependencies_out);
  goto __pyx_L0;
...
*/
  __pyx_r = cudaStreamGetCaptureInfo_v3(__pyx_v_stream, __pyx_v_captureStatus_out, __pyx_v_id_out, __pyx_v_graph_out, __pyx_v_dependencies_out, __pyx_v_edgeData_out, __pyx_v_numDependencies_out);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamUpdateCaptureDependencies(cudaStream_t __pyx_v_stream, cudaGraphNode_t *__pyx_v_dependencies, size_t __pyx_v_numDependencies, unsigned int __pyx_v_flags) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaStreamUpdateCaptureDependencies(__pyx_v_stream, __pyx_v_dependencies, __pyx_v_numDependencies, __pyx_v_flags);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamUpdateCaptureDependencies_v2(cudaStream_t __pyx_v_stream, cudaGraphNode_t *__pyx_v_dependencies, cudaGraphEdgeData const *__pyx_v_dependencyData, size_t __pyx_v_numDependencies, unsigned int __pyx_v_flags) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaStreamUpdateCaptureDependencies_v2(__pyx_v_stream, __pyx_v_dependencies, __pyx_v_dependencyData, __pyx_v_numDependencies, __pyx_v_flags);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventElapsedTime_v2(float *__pyx_v_ms, cudaEvent_t __pyx_v_start, cudaEvent_t __pyx_v_end) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaEventElapsedTime_v2(__pyx_v_ms, __pyx_v_start, __pyx_v_end);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaSignalExternalSemaphoresAsync_v2(cudaExternalSemaphore_t const *__pyx_v_extSemArray, struct cudaExternalSemaphoreSignalParams const *__pyx_v_paramsArray, unsigned int __pyx_v_numExtSems, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaSignalExternalSemaphoresAsync_v2_ptsz(__pyx_v_extSemArray, __pyx_v_paramsArray, __pyx_v_numExtSems, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaWaitExternalSemaphoresAsync_v2(cudaExternalSemaphore_t const *__pyx_v_extSemArray, struct cudaExternalSemaphoreWaitParams const *__pyx_v_paramsArray, unsigned int __pyx_v_numExtSems, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaWaitExternalSemaphoresAsync_v2_ptsz(__pyx_v_extSemArray, __pyx_v_paramsArray, __pyx_v_numExtSems, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyBatchAsync(void **__pyx_v_dsts, void **__pyx_v_srcs, size_t *__pyx_v_sizes, size_t __pyx_v_count, struct cudaMemcpyAttributes *__pyx_v_attrs, size_t *__pyx_v_attrsIdxs, size_t __pyx_v_numAttrs, size_t *__pyx_v_failIdx, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemcpyBatchAsync(__pyx_v_dsts, __pyx_v_srcs, __pyx_v_sizes, __pyx_v_count, __pyx_v_attrs, __pyx_v_attrsIdxs, __pyx_v_numAttrs, __pyx_v_failIdx, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3DBatchAsync(size_t __pyx_v_numOps, struct cudaMemcpy3DBatchOp *__pyx_v_opList, size_t *__pyx_v_failIdx, unsigned PY_LONG_LONG __pyx_v_flags, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemcpy3DBatchAsync(__pyx_v_numOps, __pyx_v_opList, __pyx_v_failIdx, __pyx_v_flags, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPrefetchAsync(void const *__pyx_v_devPtr, size_t __pyx_v_count, int __pyx_v_dstDevice, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemPrefetchAsync(__pyx_v_devPtr, __pyx_v_count, __pyx_v_dstDevice, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPrefetchAsync_v2(void const *__pyx_v_devPtr, size_t __pyx_v_count, struct cudaMemLocation __pyx_v_location, unsigned int __pyx_v_flags, cudaStream_t __pyx_v_stream) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemPrefetchAsync_v2(__pyx_v_devPtr, __pyx_v_count, __pyx_v_location, __pyx_v_flags, __pyx_v_stream);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemAdvise(void const *__pyx_v_devPtr, size_t __pyx_v_count, enum cudaMemoryAdvise __pyx_v_advice, int __pyx_v_device) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemAdvise(__pyx_v_devPtr, __pyx_v_count, __pyx_v_advice, __pyx_v_device);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemAdvise_v2(void const *__pyx_v_devPtr, size_t __pyx_v_count, enum cudaMemoryAdvise __pyx_v_advice, struct cudaMemLocation __pyx_v_location) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaMemAdvise_v2(__pyx_v_devPtr, __pyx_v_count, __pyx_v_advice, __pyx_v_location);
  goto __pyx_L0;
...
/* "cuda/bindings/_bindings/cyruntime_ptds.pyx":535
 * cdef cudaError_t _cudaGetChannelDesc(cudaChannelFormatDesc* desc, cudaArray_const_t array) except ?cudaErrorCallRequiresNewerDriver nogil:
 *     return cudaGetChannelDesc(desc, array)
 * @cython.show_performance_hints(False)             # <<<<<<<<<<<<<<
 * cdef cudaChannelFormatDesc _cudaCreateChannelDesc(int x, int y, int z, int w, cudaChannelFormatKind f) except* nogil:
...
/* "cuda/bindings/_bindings/cyruntime_ptds.pyx":545
 *     return cudaDestroyTextureObject(texObject)
 * 
 * cdef cudaError_t _cudaGetTextureObjectResourceDesc(cudaResourceDesc* pResDesc, cudaTextureObject_t texObject) except ?cudaErrorCallRequiresNewerDriver nogil:             # <<<<<<<<<<<<<<
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeCopyAttributes(cudaGraphNode_t __pyx_v_hSrc, cudaGraphNode_t __pyx_v_hDst) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphKernelNodeCopyAttributes(__pyx_v_hSrc, __pyx_v_hDst);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetEdges(cudaGraph_t __pyx_v_graph, cudaGraphNode_t *__pyx_v_from_, cudaGraphNode_t *__pyx_v_to, size_t *__pyx_v_numEdges) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphGetEdges(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_numEdges);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetEdges_v2(cudaGraph_t __pyx_v_graph, cudaGraphNode_t *__pyx_v_from_, cudaGraphNode_t *__pyx_v_to, cudaGraphEdgeData *__pyx_v_edgeData, size_t *__pyx_v_numEdges) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphGetEdges_v2(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_edgeData, __pyx_v_numEdges);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependencies(cudaGraphNode_t __pyx_v_node, cudaGraphNode_t *__pyx_v_pDependencies, size_t *__pyx_v_pNumDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphNodeGetDependencies(__pyx_v_node, __pyx_v_pDependencies, __pyx_v_pNumDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependencies_v2(cudaGraphNode_t __pyx_v_node, cudaGraphNode_t *__pyx_v_pDependencies, cudaGraphEdgeData *__pyx_v_edgeData, size_t *__pyx_v_pNumDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphNodeGetDependencies_v2(__pyx_v_node, __pyx_v_pDependencies, __pyx_v_edgeData, __pyx_v_pNumDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependentNodes(cudaGraphNode_t __pyx_v_node, cudaGraphNode_t *__pyx_v_pDependentNodes, size_t *__pyx_v_pNumDependentNodes) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphNodeGetDependentNodes(__pyx_v_node, __pyx_v_pDependentNodes, __pyx_v_pNumDependentNodes);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependentNodes_v2(cudaGraphNode_t __pyx_v_node, cudaGraphNode_t *__pyx_v_pDependentNodes, cudaGraphEdgeData *__pyx_v_edgeData, size_t *__pyx_v_pNumDependentNodes) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphNodeGetDependentNodes_v2(__pyx_v_node, __pyx_v_pDependentNodes, __pyx_v_edgeData, __pyx_v_pNumDependentNodes);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddDependencies(cudaGraph_t __pyx_v_graph, cudaGraphNode_t const *__pyx_v_from_, cudaGraphNode_t const *__pyx_v_to, size_t __pyx_v_numDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphAddDependencies(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_numDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddDependencies_v2(cudaGraph_t __pyx_v_graph, cudaGraphNode_t const *__pyx_v_from_, cudaGraphNode_t const *__pyx_v_to, cudaGraphEdgeData const *__pyx_v_edgeData, size_t __pyx_v_numDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphAddDependencies_v2(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_edgeData, __pyx_v_numDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphRemoveDependencies(cudaGraph_t __pyx_v_graph, cudaGraphNode_t const *__pyx_v_from_, cudaGraphNode_t const *__pyx_v_to, size_t __pyx_v_numDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphRemoveDependencies(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_numDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphRemoveDependencies_v2(cudaGraph_t __pyx_v_graph, cudaGraphNode_t const *__pyx_v_from_, cudaGraphNode_t const *__pyx_v_to, cudaGraphEdgeData const *__pyx_v_edgeData, size_t __pyx_v_numDependencies) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphRemoveDependencies_v2(__pyx_v_graph, __pyx_v_from_, __pyx_v_to, __pyx_v_edgeData, __pyx_v_numDependencies);
  goto __pyx_L0;
...
static cudaError_t __pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddNode(cudaGraphNode_t *__pyx_v_pGraphNode, cudaGraph_t __pyx_v_graph, cudaGraphNode_t const *__pyx_v_pDependencies, size_t __pyx_v_numDependencies, struct cudaGraphNodeParams *__pyx_v_nodeParams) {
  cudaError_t __pyx_r;
...
*/
  __pyx_r = cudaGraphAddNode(__pyx_v_pGraphNode, __pyx_v_graph, __pyx_v_pDependencies, __pyx_v_numDependencies, __pyx_v_nodeParams);
  goto __pyx_L0;
...
*/
  __pyx_r = cudaGraphAddNode_v2(__pyx_v_pGraphNode, __pyx_v_graph, __pyx_v_pDependencies, __pyx_v_dependencyData, __pyx_v_numDependencies, __pyx_v_nodeParams);
  goto __pyx_L0;
...
/* "cuda/bindings/_bindings/cyruntime_ptds.pyx":874
 * cdef cudaError_t _cudaGetKernel(cudaKernel_t* kernelPtr, const void* entryFuncAddr) except ?cudaErrorCallRequiresNewerDriver nogil:
 *     return cudaGetKernel(kernelPtr, entryFuncAddr)
 * @cython.show_performance_hints(False)             # <<<<<<<<<<<<<<
 * cdef cudaPitchedPtr _make_cudaPitchedPtr(void* d, size_t p, size_t xsz, size_t ysz) except* nogil:
...
/* "cuda/bindings/_bindings/cyruntime_ptds.pyx":877
 * cdef cudaPitchedPtr _make_cudaPitchedPtr(void* d, size_t p, size_t xsz, size_t ysz) except* nogil:
 *     return make_cudaPitchedPtr(d, p, xsz, ysz)
 * @cython.show_performance_hints(False)             # <<<<<<<<<<<<<<
 * cdef cudaPos _make_cudaPos(size_t x, size_t y, size_t z) except* nogil:
...
/* "cuda/bindings/_bindings/cyruntime_ptds.pyx":880
 * cdef cudaPos _make_cudaPos(size_t x, size_t y, size_t z) except* nogil:
 *     return make_cudaPos(x, y, z)
 * @cython.show_performance_hints(False)             # <<<<<<<<<<<<<<
 * cdef cudaExtent _make_cudaExtent(size_t w, size_t h, size_t d) except* nogil:
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("_cudaDeviceReset", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceReset, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSynchronize", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSynchronize, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSetLimit", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSetLimit, "cudaError_t (enum cudaLimit, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetLimit", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetLimit, "cudaError_t (size_t *, enum cudaLimit)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetTexture1DLinearMaxWidth", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetTexture1DLinearMaxWidth, "cudaError_t (size_t *, struct cudaChannelFormatDesc const *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetCacheConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetCacheConfig, "cudaError_t (enum cudaFuncCache *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetStreamPriorityRange", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetStreamPriorityRange, "cudaError_t (int *, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSetCacheConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSetCacheConfig, "cudaError_t (enum cudaFuncCache)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetByPCIBusId", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetByPCIBusId, "cudaError_t (int *, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetPCIBusId", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetPCIBusId, "cudaError_t (char *, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaIpcGetEventHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaIpcGetEventHandle, "cudaError_t (cudaIpcEventHandle_t *, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaIpcOpenEventHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaIpcOpenEventHandle, "cudaError_t (cudaEvent_t *, cudaIpcEventHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaIpcGetMemHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaIpcGetMemHandle, "cudaError_t (cudaIpcMemHandle_t *, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaIpcOpenMemHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaIpcOpenMemHandle, "cudaError_t (void **, cudaIpcMemHandle_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaIpcCloseMemHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaIpcCloseMemHandle, "cudaError_t (void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceFlushGPUDirectRDMAWrites", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceFlushGPUDirectRDMAWrites, "cudaError_t (enum cudaFlushGPUDirectRDMAWritesTarget, enum cudaFlushGPUDirectRDMAWritesScope)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceRegisterAsyncNotification", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceRegisterAsyncNotification, "cudaError_t (int, cudaAsyncCallback, void *, cudaAsyncCallbackHandle_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceUnregisterAsyncNotification", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceUnregisterAsyncNotification, "cudaError_t (int, cudaAsyncCallbackHandle_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetSharedMemConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetSharedMemConfig, "cudaError_t (enum cudaSharedMemConfig *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSetSharedMemConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSetSharedMemConfig, "cudaError_t (enum cudaSharedMemConfig)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetLastError", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetLastError, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaPeekAtLastError", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaPeekAtLastError, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetErrorName", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetErrorName, "char const *(cudaError_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetErrorString", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetErrorString, "char const *(cudaError_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDeviceCount", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDeviceCount, "cudaError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDeviceProperties_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDeviceProperties_v2, "cudaError_t (struct cudaDeviceProp *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetAttribute, "cudaError_t (int *, enum cudaDeviceAttr, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetDefaultMemPool", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetDefaultMemPool, "cudaError_t (cudaMemPool_t *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSetMemPool", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSetMemPool, "cudaError_t (int, cudaMemPool_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetMemPool", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetMemPool, "cudaError_t (cudaMemPool_t *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetNvSciSyncAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetNvSciSyncAttributes, "cudaError_t (void *, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetP2PAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetP2PAttribute, "cudaError_t (int *, enum cudaDeviceP2PAttr, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaChooseDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaChooseDevice, "cudaError_t (int *, struct cudaDeviceProp const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaInitDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaInitDevice, "cudaError_t (int, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaSetDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaSetDevice, "cudaError_t (int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDevice, "cudaError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaSetDeviceFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaSetDeviceFlags, "cudaError_t (unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDeviceFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDeviceFlags, "cudaError_t (unsigned int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamCreate, "cudaError_t (cudaStream_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamCreateWithFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamCreateWithFlags, "cudaError_t (cudaStream_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamCreateWithPriority", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamCreateWithPriority, "cudaError_t (cudaStream_t *, unsigned int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetPriority", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetPriority, "cudaError_t (cudaStream_t, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetFlags, "cudaError_t (cudaStream_t, unsigned int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetId", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetId, "cudaError_t (cudaStream_t, unsigned PY_LONG_LONG *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetDevice, "cudaError_t (cudaStream_t, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaCtxResetPersistingL2Cache", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaCtxResetPersistingL2Cache, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamCopyAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamCopyAttributes, "cudaError_t (cudaStream_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetAttribute, "cudaError_t (cudaStream_t, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaStreamAttrID, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaStreamAttrValue *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamSetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamSetAttribute, "cudaError_t (cudaStream_t, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaStreamAttrID, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaStreamAttrValue const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamDestroy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamDestroy, "cudaError_t (cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamWaitEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamWaitEvent, "cudaError_t (cudaStream_t, cudaEvent_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamAddCallback", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamAddCallback, "cudaError_t (cudaStream_t, cudaStreamCallback_t, void *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamSynchronize", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamSynchronize, "cudaError_t (cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamQuery", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamQuery, "cudaError_t (cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamAttachMemAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamAttachMemAsync, "cudaError_t (cudaStream_t, void *, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamBeginCapture", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamBeginCapture, "cudaError_t (cudaStream_t, enum cudaStreamCaptureMode)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamBeginCaptureToGraph", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamBeginCaptureToGraph, "cudaError_t (cudaStream_t, cudaGraph_t, cudaGraphNode_t const *, cudaGraphEdgeData const *, size_t, enum cudaStreamCaptureMode)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaThreadExchangeStreamCaptureMode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaThreadExchangeStreamCaptureMode, "cudaError_t (enum cudaStreamCaptureMode *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamEndCapture", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamEndCapture, "cudaError_t (cudaStream_t, cudaGraph_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamIsCapturing", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamIsCapturing, "cudaError_t (cudaStream_t, enum cudaStreamCaptureStatus *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetCaptureInfo_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetCaptureInfo_v2, "cudaError_t (cudaStream_t, enum cudaStreamCaptureStatus *, unsigned PY_LONG_LONG *, cudaGraph_t *, cudaGraphNode_t const **, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamGetCaptureInfo_v3", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamGetCaptureInfo_v3, "cudaError_t (cudaStream_t, enum cudaStreamCaptureStatus *, unsigned PY_LONG_LONG *, cudaGraph_t *, cudaGraphNode_t const **, cudaGraphEdgeData const **, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamUpdateCaptureDependencies", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamUpdateCaptureDependencies, "cudaError_t (cudaStream_t, cudaGraphNode_t *, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaStreamUpdateCaptureDependencies_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaStreamUpdateCaptureDependencies_v2, "cudaError_t (cudaStream_t, cudaGraphNode_t *, cudaGraphEdgeData const *, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventCreate, "cudaError_t (cudaEvent_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventCreateWithFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventCreateWithFlags, "cudaError_t (cudaEvent_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventRecord", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventRecord, "cudaError_t (cudaEvent_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventRecordWithFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventRecordWithFlags, "cudaError_t (cudaEvent_t, cudaStream_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventQuery", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventQuery, "cudaError_t (cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventSynchronize", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventSynchronize, "cudaError_t (cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventDestroy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventDestroy, "cudaError_t (cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventElapsedTime", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventElapsedTime, "cudaError_t (float *, cudaEvent_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaEventElapsedTime_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaEventElapsedTime_v2, "cudaError_t (float *, cudaEvent_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaImportExternalMemory", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaImportExternalMemory, "cudaError_t (cudaExternalMemory_t *, struct cudaExternalMemoryHandleDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaExternalMemoryGetMappedBuffer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaExternalMemoryGetMappedBuffer, "cudaError_t (void **, cudaExternalMemory_t, struct cudaExternalMemoryBufferDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaExternalMemoryGetMappedMipmappedArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaExternalMemoryGetMappedMipmappedArray, "cudaError_t (cudaMipmappedArray_t *, cudaExternalMemory_t, struct cudaExternalMemoryMipmappedArrayDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDestroyExternalMemory", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDestroyExternalMemory, "cudaError_t (cudaExternalMemory_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaImportExternalSemaphore", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaImportExternalSemaphore, "cudaError_t (cudaExternalSemaphore_t *, struct cudaExternalSemaphoreHandleDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaSignalExternalSemaphoresAsync_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaSignalExternalSemaphoresAsync_v2, "cudaError_t (cudaExternalSemaphore_t const *, struct cudaExternalSemaphoreSignalParams const *, unsigned int, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaWaitExternalSemaphoresAsync_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaWaitExternalSemaphoresAsync_v2, "cudaError_t (cudaExternalSemaphore_t const *, struct cudaExternalSemaphoreWaitParams const *, unsigned int, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDestroyExternalSemaphore", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDestroyExternalSemaphore, "cudaError_t (cudaExternalSemaphore_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFuncSetCacheConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFuncSetCacheConfig, "cudaError_t (void const *, enum cudaFuncCache)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFuncGetAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFuncGetAttributes, "cudaError_t (struct cudaFuncAttributes *, void const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFuncSetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFuncSetAttribute, "cudaError_t (void const *, enum cudaFuncAttribute, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLaunchHostFunc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLaunchHostFunc, "cudaError_t (cudaStream_t, cudaHostFn_t, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFuncSetSharedMemConfig", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFuncSetSharedMemConfig, "cudaError_t (void const *, enum cudaSharedMemConfig)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaOccupancyMaxActiveBlocksPerMultiprocessor", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaOccupancyMaxActiveBlocksPerMultiprocessor, "cudaError_t (int *, void const *, int, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaOccupancyAvailableDynamicSMemPerBlock", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaOccupancyAvailableDynamicSMemPerBlock, "cudaError_t (size_t *, void const *, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, "cudaError_t (int *, void const *, int, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocManaged", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocManaged, "cudaError_t (void **, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMalloc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMalloc, "cudaError_t (void **, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocHost", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocHost, "cudaError_t (void **, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocPitch", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocPitch, "cudaError_t (void **, size_t *, size_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocArray, "cudaError_t (cudaArray_t *, struct cudaChannelFormatDesc const *, size_t, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFree", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFree, "cudaError_t (void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFreeHost", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFreeHost, "cudaError_t (void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFreeArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFreeArray, "cudaError_t (cudaArray_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFreeMipmappedArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFreeMipmappedArray, "cudaError_t (cudaMipmappedArray_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaHostAlloc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaHostAlloc, "cudaError_t (void **, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaHostRegister", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaHostRegister, "cudaError_t (void *, size_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaHostUnregister", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaHostUnregister, "cudaError_t (void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaHostGetDevicePointer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaHostGetDevicePointer, "cudaError_t (void **, void *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaHostGetFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaHostGetFlags, "cudaError_t (unsigned int *, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMalloc3D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMalloc3D, "cudaError_t (struct cudaPitchedPtr *, struct cudaExtent)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMalloc3DArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMalloc3DArray, "cudaError_t (cudaArray_t *, struct cudaChannelFormatDesc const *, struct cudaExtent, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocMipmappedArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocMipmappedArray, "cudaError_t (cudaMipmappedArray_t *, struct cudaChannelFormatDesc const *, struct cudaExtent, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetMipmappedArrayLevel", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetMipmappedArrayLevel, "cudaError_t (cudaArray_t *, cudaMipmappedArray_const_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy3D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3D, "cudaError_t (struct cudaMemcpy3DParms const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy3DPeer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3DPeer, "cudaError_t (struct cudaMemcpy3DPeerParms const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy3DAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3DAsync, "cudaError_t (struct cudaMemcpy3DParms const *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy3DPeerAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3DPeerAsync, "cudaError_t (struct cudaMemcpy3DPeerParms const *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemGetInfo", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemGetInfo, "cudaError_t (size_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaArrayGetInfo", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaArrayGetInfo, "cudaError_t (struct cudaChannelFormatDesc *, struct cudaExtent *, unsigned int *, cudaArray_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaArrayGetPlane", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaArrayGetPlane, "cudaError_t (cudaArray_t *, cudaArray_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaArrayGetMemoryRequirements", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaArrayGetMemoryRequirements, "cudaError_t (struct cudaArrayMemoryRequirements *, cudaArray_t, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMipmappedArrayGetMemoryRequirements", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMipmappedArrayGetMemoryRequirements, "cudaError_t (struct cudaArrayMemoryRequirements *, cudaMipmappedArray_t, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaArrayGetSparseProperties", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaArrayGetSparseProperties, "cudaError_t (struct cudaArraySparseProperties *, cudaArray_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMipmappedArrayGetSparseProperties", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMipmappedArrayGetSparseProperties, "cudaError_t (struct cudaArraySparseProperties *, cudaMipmappedArray_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy, "cudaError_t (void *, void const *, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyPeer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyPeer, "cudaError_t (void *, int, void const *, int, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2D, "cudaError_t (void *, size_t, void const *, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DToArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DToArray, "cudaError_t (cudaArray_t, size_t, size_t, void const *, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DFromArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DFromArray, "cudaError_t (void *, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DArrayToArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DArrayToArray, "cudaError_t (cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyAsync, "cudaError_t (void *, void const *, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyPeerAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyPeerAsync, "cudaError_t (void *, int, void const *, int, size_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyBatchAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyBatchAsync, "cudaError_t (void **, void **, size_t *, size_t, struct cudaMemcpyAttributes *, size_t *, size_t, size_t *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy3DBatchAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy3DBatchAsync, "cudaError_t (size_t, struct cudaMemcpy3DBatchOp *, size_t *, unsigned PY_LONG_LONG, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DAsync, "cudaError_t (void *, size_t, void const *, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DToArrayAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DToArrayAsync, "cudaError_t (cudaArray_t, size_t, size_t, void const *, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpy2DFromArrayAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpy2DFromArrayAsync, "cudaError_t (void *, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemset", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemset, "cudaError_t (void *, int, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemset2D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemset2D, "cudaError_t (void *, size_t, int, size_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemset3D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemset3D, "cudaError_t (struct cudaPitchedPtr, int, struct cudaExtent)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemsetAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemsetAsync, "cudaError_t (void *, int, size_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemset2DAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemset2DAsync, "cudaError_t (void *, size_t, int, size_t, size_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemset3DAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemset3DAsync, "cudaError_t (struct cudaPitchedPtr, int, struct cudaExtent, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPrefetchAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPrefetchAsync, "cudaError_t (void const *, size_t, int, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPrefetchAsync_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPrefetchAsync_v2, "cudaError_t (void const *, size_t, struct cudaMemLocation, unsigned int, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemAdvise", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemAdvise, "cudaError_t (void const *, size_t, enum cudaMemoryAdvise, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemAdvise_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemAdvise_v2, "cudaError_t (void const *, size_t, enum cudaMemoryAdvise, struct cudaMemLocation)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemRangeGetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemRangeGetAttribute, "cudaError_t (void *, size_t, enum cudaMemRangeAttribute, void const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemRangeGetAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemRangeGetAttributes, "cudaError_t (void **, size_t *, enum cudaMemRangeAttribute *, size_t, void const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyToArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyToArray, "cudaError_t (cudaArray_t, size_t, size_t, void const *, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyFromArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyFromArray, "cudaError_t (void *, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyArrayToArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyArrayToArray, "cudaError_t (cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyToArrayAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyToArrayAsync, "cudaError_t (cudaArray_t, size_t, size_t, void const *, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemcpyFromArrayAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemcpyFromArrayAsync, "cudaError_t (void *, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocAsync, "cudaError_t (void **, size_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaFreeAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaFreeAsync, "cudaError_t (void *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolTrimTo", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolTrimTo, "cudaError_t (cudaMemPool_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolSetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolSetAttribute, "cudaError_t (cudaMemPool_t, enum cudaMemPoolAttr, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolGetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolGetAttribute, "cudaError_t (cudaMemPool_t, enum cudaMemPoolAttr, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolSetAccess", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolSetAccess, "cudaError_t (cudaMemPool_t, struct cudaMemAccessDesc const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolGetAccess", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolGetAccess, "cudaError_t (enum cudaMemAccessFlags *, cudaMemPool_t, struct cudaMemLocation *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolCreate, "cudaError_t (cudaMemPool_t *, struct cudaMemPoolProps const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolDestroy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolDestroy, "cudaError_t (cudaMemPool_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMallocFromPoolAsync", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMallocFromPoolAsync, "cudaError_t (void **, size_t, cudaMemPool_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolExportToShareableHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolExportToShareableHandle, "cudaError_t (void *, cudaMemPool_t, enum cudaMemAllocationHandleType, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolImportFromShareableHandle", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolImportFromShareableHandle, "cudaError_t (cudaMemPool_t *, void *, enum cudaMemAllocationHandleType, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolExportPointer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolExportPointer, "cudaError_t (struct cudaMemPoolPtrExportData *, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaMemPoolImportPointer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaMemPoolImportPointer, "cudaError_t (void **, cudaMemPool_t, struct cudaMemPoolPtrExportData *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaPointerGetAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaPointerGetAttributes, "cudaError_t (struct cudaPointerAttributes *, void const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceCanAccessPeer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceCanAccessPeer, "cudaError_t (int *, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceEnablePeerAccess", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceEnablePeerAccess, "cudaError_t (int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceDisablePeerAccess", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceDisablePeerAccess, "cudaError_t (int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsUnregisterResource", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsUnregisterResource, "cudaError_t (cudaGraphicsResource_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsResourceSetMapFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsResourceSetMapFlags, "cudaError_t (cudaGraphicsResource_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsMapResources", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsMapResources, "cudaError_t (int, cudaGraphicsResource_t *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsUnmapResources", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsUnmapResources, "cudaError_t (int, cudaGraphicsResource_t *, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsResourceGetMappedPointer", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsResourceGetMappedPointer, "cudaError_t (void **, size_t *, cudaGraphicsResource_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsSubResourceGetMappedArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsSubResourceGetMappedArray, "cudaError_t (cudaArray_t *, cudaGraphicsResource_t, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphicsResourceGetMappedMipmappedArray", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphicsResourceGetMappedMipmappedArray, "cudaError_t (cudaMipmappedArray_t *, cudaGraphicsResource_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetChannelDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetChannelDesc, "cudaError_t (struct cudaChannelFormatDesc *, cudaArray_const_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaCreateChannelDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaCreateChannelDesc, "struct cudaChannelFormatDesc (int, int, int, int, enum cudaChannelFormatKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaCreateTextureObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaCreateTextureObject, "cudaError_t (cudaTextureObject_t *, struct cudaResourceDesc const *, struct cudaTextureDesc const *, struct cudaResourceViewDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDestroyTextureObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDestroyTextureObject, "cudaError_t (cudaTextureObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetTextureObjectResourceDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetTextureObjectResourceDesc, "cudaError_t (struct cudaResourceDesc *, cudaTextureObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetTextureObjectTextureDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetTextureObjectTextureDesc, "cudaError_t (struct cudaTextureDesc *, cudaTextureObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetTextureObjectResourceViewDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetTextureObjectResourceViewDesc, "cudaError_t (struct cudaResourceViewDesc *, cudaTextureObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaCreateSurfaceObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaCreateSurfaceObject, "cudaError_t (cudaSurfaceObject_t *, struct cudaResourceDesc const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDestroySurfaceObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDestroySurfaceObject, "cudaError_t (cudaSurfaceObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetSurfaceObjectResourceDesc", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetSurfaceObjectResourceDesc, "cudaError_t (struct cudaResourceDesc *, cudaSurfaceObject_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDriverGetVersion", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDriverGetVersion, "cudaError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaRuntimeGetVersion", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaRuntimeGetVersion, "cudaError_t (int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphCreate, "cudaError_t (cudaGraph_t *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddKernelNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddKernelNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaKernelNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphKernelNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaKernelNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphKernelNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaKernelNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphKernelNodeCopyAttributes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeCopyAttributes, "cudaError_t (cudaGraphNode_t, cudaGraphNode_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphKernelNodeGetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeGetAttribute, "cudaError_t (cudaGraphNode_t, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaKernelNodeAttrID, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaKernelNodeAttrValue *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphKernelNodeSetAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphKernelNodeSetAttribute, "cudaError_t (cudaGraphNode_t, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaKernelNodeAttrID, __pyx_t_4cuda_8bindings_9_bindings_14cyruntime_ptds_cudaKernelNodeAttrValue const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddMemcpyNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddMemcpyNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaMemcpy3DParms const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddMemcpyNode1D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddMemcpyNode1D, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, void *, void const *, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemcpyNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemcpyNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaMemcpy3DParms *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemcpyNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemcpyNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaMemcpy3DParms const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemcpyNodeSetParams1D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemcpyNodeSetParams1D, "cudaError_t (cudaGraphNode_t, void *, void const *, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddMemsetNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddMemsetNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaMemsetParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemsetNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemsetNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaMemsetParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemsetNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemsetNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaMemsetParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddHostNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddHostNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaHostNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphHostNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphHostNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaHostNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphHostNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphHostNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaHostNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddChildGraphNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddChildGraphNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, cudaGraph_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphChildGraphNodeGetGraph", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphChildGraphNodeGetGraph, "cudaError_t (cudaGraphNode_t, cudaGraph_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddEmptyNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddEmptyNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddEventRecordNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddEventRecordNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphEventRecordNodeGetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphEventRecordNodeGetEvent, "cudaError_t (cudaGraphNode_t, cudaEvent_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphEventRecordNodeSetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphEventRecordNodeSetEvent, "cudaError_t (cudaGraphNode_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddEventWaitNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddEventWaitNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphEventWaitNodeGetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphEventWaitNodeGetEvent, "cudaError_t (cudaGraphNode_t, cudaEvent_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphEventWaitNodeSetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphEventWaitNodeSetEvent, "cudaError_t (cudaGraphNode_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddExternalSemaphoresSignalNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddExternalSemaphoresSignalNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaExternalSemaphoreSignalNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExternalSemaphoresSignalNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExternalSemaphoresSignalNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaExternalSemaphoreSignalNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExternalSemaphoresSignalNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExternalSemaphoresSignalNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaExternalSemaphoreSignalNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddExternalSemaphoresWaitNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddExternalSemaphoresWaitNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaExternalSemaphoreWaitNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExternalSemaphoresWaitNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExternalSemaphoresWaitNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaExternalSemaphoreWaitNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExternalSemaphoresWaitNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExternalSemaphoresWaitNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaExternalSemaphoreWaitNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddMemAllocNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddMemAllocNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaMemAllocNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemAllocNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemAllocNodeGetParams, "cudaError_t (cudaGraphNode_t, struct cudaMemAllocNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddMemFreeNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddMemFreeNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphMemFreeNodeGetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphMemFreeNodeGetParams, "cudaError_t (cudaGraphNode_t, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGraphMemTrim", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGraphMemTrim, "cudaError_t (int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceGetGraphMemAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceGetGraphMemAttribute, "cudaError_t (int, enum cudaGraphMemAttributeType, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaDeviceSetGraphMemAttribute", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaDeviceSetGraphMemAttribute, "cudaError_t (int, enum cudaGraphMemAttributeType, void *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphClone", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphClone, "cudaError_t (cudaGraph_t *, cudaGraph_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeFindInClone", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeFindInClone, "cudaError_t (cudaGraphNode_t *, cudaGraphNode_t, cudaGraph_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetType", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetType, "cudaError_t (cudaGraphNode_t, enum cudaGraphNodeType *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphGetNodes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetNodes, "cudaError_t (cudaGraph_t, cudaGraphNode_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphGetRootNodes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetRootNodes, "cudaError_t (cudaGraph_t, cudaGraphNode_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphGetEdges", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetEdges, "cudaError_t (cudaGraph_t, cudaGraphNode_t *, cudaGraphNode_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphGetEdges_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphGetEdges_v2, "cudaError_t (cudaGraph_t, cudaGraphNode_t *, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetDependencies", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependencies, "cudaError_t (cudaGraphNode_t, cudaGraphNode_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetDependencies_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependencies_v2, "cudaError_t (cudaGraphNode_t, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetDependentNodes", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependentNodes, "cudaError_t (cudaGraphNode_t, cudaGraphNode_t *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetDependentNodes_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetDependentNodes_v2, "cudaError_t (cudaGraphNode_t, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddDependencies", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddDependencies, "cudaError_t (cudaGraph_t, cudaGraphNode_t const *, cudaGraphNode_t const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddDependencies_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddDependencies_v2, "cudaError_t (cudaGraph_t, cudaGraphNode_t const *, cudaGraphNode_t const *, cudaGraphEdgeData const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphRemoveDependencies", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphRemoveDependencies, "cudaError_t (cudaGraph_t, cudaGraphNode_t const *, cudaGraphNode_t const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphRemoveDependencies_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphRemoveDependencies_v2, "cudaError_t (cudaGraph_t, cudaGraphNode_t const *, cudaGraphNode_t const *, cudaGraphEdgeData const *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphDestroyNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphDestroyNode, "cudaError_t (cudaGraphNode_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphInstantiate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphInstantiate, "cudaError_t (cudaGraphExec_t *, cudaGraph_t, unsigned PY_LONG_LONG)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphInstantiateWithFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphInstantiateWithFlags, "cudaError_t (cudaGraphExec_t *, cudaGraph_t, unsigned PY_LONG_LONG)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphInstantiateWithParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphInstantiateWithParams, "cudaError_t (cudaGraphExec_t *, cudaGraph_t, cudaGraphInstantiateParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecGetFlags", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecGetFlags, "cudaError_t (cudaGraphExec_t, unsigned PY_LONG_LONG *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecKernelNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecKernelNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, struct cudaKernelNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecMemcpyNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecMemcpyNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, struct cudaMemcpy3DParms const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecMemcpyNodeSetParams1D", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecMemcpyNodeSetParams1D, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, void *, void const *, size_t, enum cudaMemcpyKind)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecMemsetNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecMemsetNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, struct cudaMemsetParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecHostNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecHostNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, struct cudaHostNodeParams const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecChildGraphNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecChildGraphNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, cudaGraph_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecEventRecordNodeSetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecEventRecordNodeSetEvent, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecEventWaitNodeSetEvent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecEventWaitNodeSetEvent, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, cudaEvent_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__Pyx_ExportFunction("_cudaGraphNodeSetEnabled", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeSetEnabled, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeGetEnabled", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeGetEnabled, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, unsigned int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecUpdate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecUpdate, "cudaError_t (cudaGraphExec_t, cudaGraph_t, cudaGraphExecUpdateResultInfo *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphUpload", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphUpload, "cudaError_t (cudaGraphExec_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphLaunch", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphLaunch, "cudaError_t (cudaGraphExec_t, cudaStream_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecDestroy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecDestroy, "cudaError_t (cudaGraphExec_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphDestroy", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphDestroy, "cudaError_t (cudaGraph_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphDebugDotPrint", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphDebugDotPrint, "cudaError_t (cudaGraph_t, char const *, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaUserObjectCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaUserObjectCreate, "cudaError_t (cudaUserObject_t *, void *, cudaHostFn_t, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaUserObjectRetain", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaUserObjectRetain, "cudaError_t (cudaUserObject_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaUserObjectRelease", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaUserObjectRelease, "cudaError_t (cudaUserObject_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphRetainUserObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphRetainUserObject, "cudaError_t (cudaGraph_t, cudaUserObject_t, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphReleaseUserObject", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphReleaseUserObject, "cudaError_t (cudaGraph_t, cudaUserObject_t, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddNode", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddNode, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, size_t, struct cudaGraphNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphAddNode_v2", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphAddNode_v2, "cudaError_t (cudaGraphNode_t *, cudaGraph_t, cudaGraphNode_t const *, cudaGraphEdgeData const *, size_t, struct cudaGraphNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphNodeSetParams, "cudaError_t (cudaGraphNode_t, struct cudaGraphNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphExecNodeSetParams", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphExecNodeSetParams, "cudaError_t (cudaGraphExec_t, cudaGraphNode_t, struct cudaGraphNodeParams *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGraphConditionalHandleCreate", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGraphConditionalHandleCreate, "cudaError_t (cudaGraphConditionalHandle *, cudaGraph_t, unsigned int, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDriverEntryPoint", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDriverEntryPoint, "cudaError_t (char const *, void **, unsigned PY_LONG_LONG, enum cudaDriverEntryPointQueryResult *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetDriverEntryPointByVersion", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetDriverEntryPointByVersion, "cudaError_t (char const *, void **, unsigned int, unsigned PY_LONG_LONG, enum cudaDriverEntryPointQueryResult *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryLoadData", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryLoadData, "cudaError_t (cudaLibrary_t *, void const *, enum cudaJitOption *, void **, unsigned int, enum cudaLibraryOption *, void **, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryLoadFromFile", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryLoadFromFile, "cudaError_t (cudaLibrary_t *, char const *, enum cudaJitOption *, void **, unsigned int, enum cudaLibraryOption *, void **, unsigned int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryUnload", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryUnload, "cudaError_t (cudaLibrary_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryGetKernel", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryGetKernel, "cudaError_t (cudaKernel_t *, cudaLibrary_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryGetGlobal", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryGetGlobal, "cudaError_t (void **, size_t *, cudaLibrary_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryGetManaged", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryGetManaged, "cudaError_t (void **, size_t *, cudaLibrary_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryGetUnifiedFunction", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryGetUnifiedFunction, "cudaError_t (void **, cudaLibrary_t, char const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryGetKernelCount", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryGetKernelCount, "cudaError_t (unsigned int *, cudaLibrary_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaLibraryEnumerateKernels", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaLibraryEnumerateKernels, "cudaError_t (cudaKernel_t *, unsigned int, cudaLibrary_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaKernelSetAttributeForDevice", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaKernelSetAttributeForDevice, "cudaError_t (cudaKernel_t, enum cudaFuncAttribute, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetExportTable", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetExportTable, "cudaError_t (void const **, cudaUUID_t const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaGetKernel", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaGetKernel, "cudaError_t (cudaKernel_t *, void const *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_make_cudaPitchedPtr", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__make_cudaPitchedPtr, "struct cudaPitchedPtr (void *, size_t, size_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_make_cudaPos", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__make_cudaPos, "struct cudaPos (size_t, size_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_make_cudaExtent", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__make_cudaExtent, "struct cudaExtent (size_t, size_t, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaProfilerStart", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaProfilerStart, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_cudaProfilerStop", (void (*)(void))__pyx_f_4cuda_8bindings_9_bindings_14cyruntime_ptds__cudaProfilerStop, "cudaError_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
