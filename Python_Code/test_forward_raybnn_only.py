...
def main():
    ...
    def plot_loss_from_log(log_file_path):
        ...
        try:
            ...
            if min(loss_values) > 0:
                ...
                ax3.set_title('Loss RayBNN only')
            ...
            plt.tight_layout()
            plt.savefig('training_loss_raybnn_only.png', dpi=300, bbox_inches='tight')
            plt.show()
    ...
    log_file = r"/home/hbui/Downloads/RayBNN_Python/Python_Code/print_forward_pass_raybnn_only.txt" 
