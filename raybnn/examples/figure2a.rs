...
fn main() {
	...
	let active_size_list = vec![10,10,20,40,80,160,320,640,1280,2000,4000,8000,16000,32000,64000,128000,256000,512000,1024000,2000000,4000000,8000000,16000000];
