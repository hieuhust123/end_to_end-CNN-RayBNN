...
legend(neural_network_list,'Location','south','box','off','FontSize',fontsz,'NumColumns',2);
xlabel('Num. APs','FontSize',fontsz);
ylabel('Segment Training Time (s)', 'FontSize',fontsz);
hold off
drawnow;

saveas(gcf,'RSSITimeSeg','fig');
saveas(gcf,'RSSITimeSeg','png');
