...
def main():
    ...
    input_csv = np.loadtxt("RSSI_train.dat", delimiter=',')
    ...
    np.savetxt("Alcala_TRAINY.dat", RSSI_trainy, delimiter=",", fmt='%.10f')
    ...
    np.savetxt("Alcala_TRAINX.dat", RSSI_trainx, delimiter=",", fmt='%.10f')
