...
def main():
	...
	class Learner(pl.LightningModule):
		def __init__(self):
			...
			self.LSTM = nn.LSTM(input_size=neuron_size, hidden_size=neuron_size, num_layers=2, bidirectional=True)
			self.output_dense0 = nn.Linear(2*neuron_size, neuron_size)
		...
		def forward(self, x):
			...
			out3 = torch.reshape(LSTMout, (traj_size*batch_size, 2*neuron_size))
