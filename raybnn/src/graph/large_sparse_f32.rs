    ...
    ) -> arrayfire::Array<f32>
{
    ...
    let output_vec: Vec<arrayfire::Array<f32> > = (input_start, input_end, block_start,  block_end).into_par_iter()
    ...
    ) -> arrayfire::Array<f32>
{
    ...
    let output_vec: Vec<arrayfire::Array<f32> > = (pointer_start, pointer_end, seg_size).into_par_iter()
