...
pub fn broadcast_array(
	...
	target_arr: &mut arrayfire::Array<f64>
)
{
    //TO CPU
    let mut target_arr_cpu = vec!(f64::default();target_arr.elements());
...
)
{
    ...
    let mut temp_cpu = vec![0f64; (input_dim0 as usize) * (MPI_size as usize)];
